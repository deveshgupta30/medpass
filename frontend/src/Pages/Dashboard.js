...
import RecordCardDashboard from "../Components/RecordCardDashboard";
...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      <div>
        <Navbar />
        <div className="flex flex-wrap justify-start items-start mr-auto px-4">
